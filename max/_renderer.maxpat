...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 601.0, 367.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 597.0, 428.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "scale~ 0 1 9 20"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 874.5, 374.0, 130.0, 130.0 ],
					"presentation_rect" : [ 868.5, 373.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 974.5, 281.0, 33.0, 22.0 ],
					"presentation_rect" : [ 974.5, 280.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-59",
					"items" : [ "none", ",", "accel.", ",", "decel." ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 924.5, 246.0, 100.0, 22.0 ],
					"presentation_rect" : [ 924.5, 245.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 874.5, 310.0, 119.0, 22.0 ],
					"presentation_rect" : [ 874.5, 309.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "velocitySwitch 0.001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 837.5, 281.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 737.5, 374.0, 130.0, 130.0 ],
					"presentation_rect" : [ 712.0, 363.0, 0.0, 0.0 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 84.549988, 40.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 127.149963, 133.0, 38.0, 22.0 ],
									"style" : "",
									"text" : "!-~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 84.549988, 177.0, 90.0, 22.0 ],
									"style" : "",
									"text" : "scale~ -1 1 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 84.549988, 100.0, 62.0, 22.0 ],
									"style" : "",
									"text" : "cycle~ #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 224.0, 53.549988, 22.0 ],
									"style" : "",
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 127.149963, 40.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 382.400024, 315.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 787.5, 246.0, 100.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 737.5, 310.0, 119.0, 22.0 ],
					"style" : "",
					"text" : "velocitySwitch 0.001"
				}
...
,
					"patching_rect" : [ 269.950012, 234.0, 84.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.220001, 573.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "r _sfrec"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 110.200012, 192.0, 172.0, 24.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 206.050018, 383.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "scale~ -1. 1. 0. 1"
				}
...
,
					"patching_rect" : [ 142.150024, 383.0, 50.949989, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.220001, 599.0, 25.5, 25.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 59.0, 646.0, 70.5, 22.0 ],
					"style" : "",
					"text" : "sfrecord~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 142.15004, 416.0, 82.899979, 22.0 ],
					"style" : "",
					"text" : "panner"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 110.200012, 234.0, 38.0, 22.0 ],
					"style" : "",
					"text" : "+~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 142.150024, 351.0, 259.25, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.419983, 17.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 592.419983, 45.0, 117.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 307.419983, 77.0, 395.633331, 57.0 ],
					"setmode" : 1,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 482.419983, 45.0, 106.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 382.400024, 270.0, 170.0, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 6097.833496, "ms" ],
						"loopstart" : [ 0.0, "ms" ],
						"mode" : "basic",
						"originallength" : [ 26595.175781, "ticks" ],
						"originaltempo" : 120.683739,
						"phase" : [ 0.0, "ticks" ],
						"pitchcorrection" : 0,
						"quality" : "basic",
						"timestretch" : [ 0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 482.419983, 17.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 327.419983, 45.0, 153.0, 22.0 ],
					"style" : "",
					"text_width" : 82.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.419983, 17.0, 173.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 142.15004, 452.0, 83.0, 143.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 142.15004, 621.5, 46.5, 46.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 599.0, 36.5, 22.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 95.25, 222.5, 391.900024, 222.5 ],
					"order" : 0,
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 119.700012, 262.0, 391.900024, 262.0 ],
					"source" : [ "obj-46", 0 ]
				}
