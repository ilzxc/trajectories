...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.220001, 528.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "r _sfrec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.625015, 50.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.200012, 22.0, 18.0, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.970001, 158.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.470001, 158.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.200012, 22.0, 18.0, 22.0 ],
					"style" : "",
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 206.050018, 338.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "scale~ -1. 1. 0. 1"
				}
...
,
					"patching_rect" : [ 142.150024, 338.0, 50.949989, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.220001, 554.0, 25.5, 25.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 59.0, 601.0, 70.5, 22.0 ],
					"style" : "",
					"text" : "sfrecord~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 142.15004, 371.0, 82.899979, 22.0 ],
					"style" : "",
					"text" : "panner"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 142.150024, 306.0, 259.25, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 382.400024, 158.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "static_ring"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 382.400024, 192.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 142.15004, 407.0, 83.0, 143.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 142.15004, 576.5, 46.5, 46.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 16.470001, 22.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "buffers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 554.0, 36.5, 22.0 ],
					"style" : "",
					"text" : "open"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 165.700012, 46.5, 119.700012, 46.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 57.470001, 228.0, 138.700012, 228.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 145.700012, 46.5, 119.700012, 46.5 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 25.970001, 228.0, 138.700012, 228.0 ],
					"source" : [ "obj-8", 0 ]
				}
